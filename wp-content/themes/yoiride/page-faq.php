			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-5 pull-left">
						<div>
							<h3>
								Här hittar ni de vanligaste frågorna och svaren angående vår verksamhet och det vi erbjuder. Är det något ni saknar eller undrar över så tveka inte utan skicka genast iväg frågan till <a href="mailto:kontakt@yoiride.se">kontakt@yoiride.se</a>!
							</h3>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-8 col-xs-12">
						...
						<ul class="nav nav-tabs faq-cat-tabs">
							...
							<li class="active"><a href="#faq-cat-1" data-toggle="tab">Vanliga frågor &amp; svar</a></li>
						</ul>
						...
						<div class="tab-content faq-cat-content">
							...
							<div class="tab-pane active in fade" id="faq-cat-1">
									...
									<div class="panel panel-default panel-faq">
										<div class="panel-heading">
											<a data-toggle="collapse" data-parent="#accordion-cat-1" href="#faq-cat-1-sub-2">
												<h4 class="panel-title">
													Varför har Dunlop så krångliga nr på sina däck? Det vore mkt enklare med soft, medium hard etc.
													<span class="pull-right"><i class="glyphicon glyphicon-plus"></i></span>
												</h4>
											</a>
										</div>
									...
									<div class="panel panel-default panel-faq">
										<div class="panel-heading">
											<a data-toggle="collapse" data-parent="#accordion-cat-1" href="#faq-cat-1-sub-3">
												<h4 class="panel-title">
													Är mitt däck slut? Kan jag köra ett pass till på detta?
													<span class="pull-right"><i class="glyphicon glyphicon-plus"></i></span>
												</h4>
											</a>
										</div>
									...
									<div class="panel panel-default panel-faq">
										<div class="panel-heading">
											<a data-toggle="collapse" data-parent="#accordion-cat-1" href="#faq-cat-1-sub-5">
												<h4 class="panel-title">
													Hur vet jag vilken hårdhet /gummiblandning jag ska välja?
													<span class="pull-right"><i class="glyphicon glyphicon-plus"></i></span>
												</h4>
											</a>
										</div>
								...
								</div><!-- PANEL GROUP 1 /.SLUT -->
							</div><!-- VANLIGA FRÅGOR & SVAR /.SLUT-->

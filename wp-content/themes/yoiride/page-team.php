		...
		<section class="white-section team-main-section">
			<div class="container"><!-- CONTAINER 970px -->
				<section class="team-profiles">
					<div class="row">
						<div class="col-md-5">
							<img src="<?php bloginfo('template_url'); ?>/img/mekaniker_profil.jpg">
							<h4 class="text-center">Kanske Dusson?</h4>
							<hr>
							<h5 class="profile-info text-center">
							Ålder: 18+<br><br>
							Bor: Gärna i Stockholmsområdet då det förenklar resor<br><br>
							Erfarenhet: Ingen tidigare erfarenhet krävs
							</h5>
							<hr class="visible-xs">
						</div>
						<div class="col-md-7">
							...
							<p>Slå en signal till Nils om du eller någon du känner skulle kunna passa in i gänget! <a href="tel:+46709346901">0709-346 901</a>
							</p>
						</div>
					</div>
				</section>
